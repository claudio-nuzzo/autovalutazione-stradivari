  ...
  function renderLesson(index, updateHash = true) {
    ...
    document.getElementById('lesson').innerHTML = `
      <article class="lesson-page" aria-labelledby="lesson-title">
        ...
        <section class="activity lesson-lab"><div><div class="kicker">Laboratorio</div><h4>${isTeacher ? 'Esercitazione per il docente' : 'Esercitazione per l’alunno'}</h4></div><p>${isTeacher ? lesson.teacherActivity : lesson.studentActivity}</p><div class="lab-output"><b>Prodotto atteso</b> Una breve evidenza del processo: decisioni, controlli eseguiti, risultato e un possibile miglioramento.</div></section>
